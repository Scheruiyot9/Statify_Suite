...
const patchDate  = async (req, res) => ok(res, await svc.patchJournalDate(req.tenantId, req.params.id, req.body.entryDate));
...
module.exports = { list, getOne, create, update, patchDate, post, voidOne, bulkImport };
