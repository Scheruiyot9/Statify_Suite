...
const submitPO  = async (req, res) => ok(res, await svc.submitPO(req.tenantId, req.params.id, req.user.userId));
...
module.exports = { listPOs, getPO, createPO, updatePO, submitPO, cancelPO, listGRNs, getGRN, createGRN, postGRN, deleteGRN };
